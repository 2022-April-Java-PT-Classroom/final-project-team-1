...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Journal adminJournal = new Journal("2022-08-01", "This is my awesome journal entry", admin);
        ...
        DateNight adminDate01 = new DateNight("2022-08-06", "Explore a new state or place", "Active", "Medium", "it was fun", admin);
