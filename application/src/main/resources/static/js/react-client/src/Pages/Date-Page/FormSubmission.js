        ...
        <div>
            <h3 className={style.dateTitle}>Tell us your experience on this date</h3>
                <form className={style.dateForm} onSubmit={handleSubmit}>
                    <input className={style.dateInput} type="date" name="dateDate" value={dateDate} onChange={handleChange}/>
                    <textarea className={style.userExperience} name="dateNotes" value={dateNotes} onChange={handleChange} placeholder='Enter your experience'></textarea>
