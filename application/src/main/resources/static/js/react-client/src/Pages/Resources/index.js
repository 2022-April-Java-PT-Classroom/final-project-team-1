...
const Resources = () => {
    return (
        ...
        <div className={style.resourcePage}>
            ...
            <div className={style.table}>
            <img src="https://th.bing.com/th?q=Twitter+Symbol+No+Background&w=120&h=120&c=1&rs=1&qlt=90&cb=1&pid=InlineBlock&mkt=en-US&cc=US&setlang=en&adlt=moderate&t=1&mw=247" alt="twitterpic"></img>
